...
_trig1act = format ["['%1','succeeded'] call BIS_fnc_taskSetState; [playableunits,5000,100] remoteExec ['fnc_ghst_addscore']; {_x setdamage 1} foreach count thislist;", _tsk];
...
_trg1 setTriggerStatements["count thislist < 6", _trig1act, "deleteVehicle thistrigger;"];