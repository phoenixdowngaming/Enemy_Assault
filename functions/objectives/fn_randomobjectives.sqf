...
private ["_position_array","_radarray","_numobjs","_campmark","_locselname","_objlist","_commanderlist","_transport_heli_list","_ammobox_list","_ghst_side","_PARAM_AISkill","_o","_random_pos","_buildarray","_curtasks","_curtasks_num","_max_reinf"];
...
//create trigger for reinforcements
{
	...
	_trig2act = format ["[%1,[2000,2000],100,1,[false,""ColorRed""],%2] spawn ghst_fnc_ecounter;", _xpos, (_PARAM_AISkill/10)];
...
While {true} do {
	...
	if ({[_x] call BIS_fnc_taskCompleted} count _curtasks == _curtasks_num) exitwith {[_random_pos,1000] spawn fnc_ghst_full_cleanup;};
