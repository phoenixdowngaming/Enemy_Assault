...
if (floor (random 10) > 5) then {
	...
	[_intelobj,["<t size='1.5' shadow='2' color='#2EFEF7'>Grab Intel</t>", "call ghst_fnc_itemfound", _tsk, 6, true, true, "",""]] remoteExec ["fnc_ghst_addaction",0,true];
	...
	_trig1act = format ["[""%1"",'succeeded'] call BIS_fnc_taskSetState;", _tsk];
