...
_trig1act = format ["deletevehicle %2; 'Bo_Mk82' createVehicle (getpos %2); [""%1"",'succeeded'] call BIS_fnc_taskSetState; [playableunits,5000,100] remoteExec ['fnc_ghst_addscore'];", _tsk, _obj];
} else {
_trig1act = format ["deletevehicle %2; [""%1"",'succeeded'] call BIS_fnc_taskSetState; [playableunits,5000,100] remoteExec ['fnc_ghst_addscore'];", _tsk, _obj];
};
