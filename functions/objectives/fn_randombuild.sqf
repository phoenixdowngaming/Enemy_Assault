...
_trig1act = format ["(%2 nearestObject '%3') setdamage 1; [""%1"",'succeeded'] call BIS_fnc_taskSetState; [playableunits,5000,100] remoteExec ['fnc_ghst_addscore'];", _tsk, _buildpos, _objtype];
