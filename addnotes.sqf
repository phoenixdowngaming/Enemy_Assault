player createDiaryRecord ["Diary", ["Recruitment","<br />Want to join PDG? Check out our website at http://www.phoenixdowngaming.com<br />Join us on teamspeak:<br />ts.phoenixdowngaming.com<br /><img image='pics\billboard.jpg' widwidth='800' height='450'/>"]];

player createDiaryRecord ["Diary", ["Credits","<br />Author - Ghost, edited by PDG Map Team. <br/>Ideas and Support by Dixon <br/>Thanks to Kylania, WardenMac and the rest of the Ghostland Team<br/><br/><img image='pics\ghostadmin_icon.paa' widwidth='256' height='256'/>"]];
